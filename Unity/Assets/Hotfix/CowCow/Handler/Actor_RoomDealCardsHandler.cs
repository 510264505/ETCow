...
namespace ETHotfix
{
    ...
    public class Actor_RoomDealCardsHandler : AMHandler<Actor_CowCowRoomDealCards>
    {
        protected override void Run(ETModel.Session session, Actor_CowCowRoomDealCards message)
        {
            ...
            rc.LoadBundle(UICowCowAB.CowCow_Texture);
            ...
            {
                gic.SetCard(i, message.Cards[i], (Sprite)rc.GetAsset(UICowCowAB.CowCow_Texture, CardHelper.GetCardAssetName(message.Cards[i])));
            }
