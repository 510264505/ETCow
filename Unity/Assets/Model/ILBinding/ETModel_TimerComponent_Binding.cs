...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_TimerComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("WaitAsync", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WaitAsync_1);
        ...
        static StackObject* WaitAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.TimerComponent instance_of_this_method = (ETModel.TimerComponent)typeof(ETModel.TimerComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* WaitAsync_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
